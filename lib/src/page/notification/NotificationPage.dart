...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //appBar: appBar('NOTIFICACIONES AMASZONAS'),
       drawer: DrawerMenu(),
      body: SafeArea(
        child: Container(
          child: Column(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    showInformation(
                        ...
                        'Las noticias y eventos más importantes y de primera mano. Familia AMASZONAS 24/7.',
                        ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    gfListTileText(
                        ...
                        entity.titulo,
                        FaIcon(FontAwesomeIcons.plane, color: AppTheme.themeRed,),
                        null, //avatarCircle(IMAGE_LOGO, 35.0),
                        EdgeInsets.all(5.0),
                        EdgeInsets.all(3.0)),
                    // ListTile(
