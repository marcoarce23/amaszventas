...
class _NewAllPagePageState extends State<NewAllPage> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Scaffold(
        appBar: appBar('PROMOCIONES - EVENTOS'),
        drawer: DrawerMenu(),
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                ...
                title: Text('Listado Promociones')),
          ],
          currentIndex: page,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  text('CARGA PROMOCIONES Y EVENTOS', AppTheme.themeGrey, 1,
                      14.0),
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        _text(
            controllerNoticia,
            entity.titulo,
            '(*) Registra Promoción - evento',
            100,
            2,
            'Ingrese la promoción-evento',
            true,
        ...
        _text(
            controllerDetalle,
            entity.objetivo,
            'Detalle de la promoción-evento',
            140,
            2,
            'Ingrese Detalle de la promoción-evento'.toUpperCase(),
            true,
            FaIcon(FontAwesomeIcons.wpforms, color: AppTheme.themeGrey),
            AppTheme.themeDefault,
            AppTheme.themeDefault,
            Colors.red),
        _text(
        ...
        _text(
            controllerUbicacion,
            entity.titulo,
            'Nivel nacional o depatamental',
            160,
            2,
            'Ingrese cobertura del evento-noticia',
            true,
            FaIcon(FontAwesomeIcons.mapMarked, color: AppTheme.themeGrey),
            AppTheme.themeDefault,
            AppTheme.themeDefault,
            Colors.red),
        _date('(*) Fecha de inicio de la campaña'),
